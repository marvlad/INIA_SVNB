...
OUTPUT_XLSM = "output/output_updated.xlsm"
...
def find_header_indices(rows):
    ...
    for row in rows:
        ...
        if a882_idx is not None and concentration_idx is not None:
            ...
            print(f"  ConcentraciÃ³n column: {concentration_idx}")

            return sample_idx, a882_idx, concentration_idx

    raise ValueError("Could not find A882 and ConcentraciÃ³n headers in CSV.")


def extract_standard_values(csv_file):
    """
    Extracts EstÃ¡ndar 1 to EstÃ¡ndar 7.

    CSV example:

        Nombre de muestra    A882       ConcentraciÃ³n
        EstÃ¡ndar 1           0,00000    0,00000
        EstÃ¡ndar 2           0,05450    0,10000
        ...
    """
    ...
    for row in rows:
        ...
        if 1 <= standard_number <= 7:
            ...
            print(
                f"Found EstÃ¡ndar {standard_number}: "
                f"A882={a882_value}, ConcentraciÃ³n={concentration_value}"
            )
...
def extract_date_from_filename(csv_file):
    ...
    Extracts date from filename like:
        ...
        CuantificaciÃ³n_23_03_2026_12_52_11.csv
...
def write_standard_values(ws, standards):
    ...
    Writes:
        ...
        CSV ConcentraciÃ³n -> Excel F15:F21
